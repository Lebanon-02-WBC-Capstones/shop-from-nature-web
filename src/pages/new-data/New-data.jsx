export const NewData = [
...

  {
    Category: "Oral Care ",
    Description:
      "This toothbrush is made from medical grade elastomer rather than traditional nylon. These bristles are supposed to be less abrasive than traditional nylon. The toothbrush heads are also replaceable, so you don’t have to purchase a whole new toothbrush every time.",
    Name: "Boie Toothbrush",
    Price: "10$",
    Tags: "Antimicrobial, Reusable",
...

  {
    Category: "Helmets",
    Description:
      "Following from the success and popularity of the heritage collections Thousand have developed a new and equally stylish but more importantly safe helmet. Engineered for performance, the Chapter Collection integrates elevated utility into your daily riding uniform to always keep you moving forward.",
    Name: "Chapter Mips Helmet",
    Price: "129$",
    Tags: "helmets, mips, safety,tech",
...

  {
    ...
    Price: "99$",
    Tags: "Anti-Corruption, Anti-Bribery, Suppliers, Contractors, Health and Safety, Reusable",
...

  {
    Category: "Books, pen",
    Description:
      "Size:Executive (6x88) Everlast gives users a classic pen and paper experience that’s built for the digital age. Mark a symbol and scan your pages using the Rocketbook App to blast your notes to the cloud. The Everlast notebook can be used with any pen, marker or highlighter from the Pilot FriXion line. Add a drop of water… and the notebook erases like magic. From the Manufacturer $2,758,871 raised with 42,213 backers.",
    Name: "Rocketbook Everlast",
    Price: "34$",
...

  {
    ...
    Description:
      "Get started with our core four to help form the foundation of a clean and sustainable home.",
...

  {
    Category: "wood",
    Description:
      "This innovative food storage container has a bamboo lid that doubles as a cutting board. The container is made from PLA, a bio plastic made from polyactic acid that is created with plant starches. The lid and container are held securely together with.",
...

  {
    ...
    Name: "Wheat mug | Stainless Liner",
    Price: "15$",
    Tags: "cup, plastic, k cup coffe, Reusable , popular",
    img1: "https://media.asicdn.com/images/jpgo/39190000/39191259.jpg",
...

  {
    Category: "Glassware",
    Description:
      "Your glass will be abundantly full with this product! The 17 oz. glass water bottles with carrying strap are made of borosilicate glass and are BPA free. Filled to capacity at 17 oz., this item consists of a rubber carrying strap that comes in select colors and will highlight your brand on the clear container. It's recommended to hand wash this glass for repeated use. Stand out at trade shows and conferences with this stunning selection. Make this the next great item in your line of promotional giveaways!",
    Name: "Glass bottle",
    Price: "15$",
    Tags: "Glass, Reusable",
  ...
  {
    Category: "Packs and bags",
    Description:
      "A classic never dies. This duffle has been showing up in gear rooms and circling luggage carousels since the early 90s. It does what duffles do best – packs huge amounts of gear. Bomber construction makes it easy to grab, easy to stuff and easy to haul.",
    Name: "Recycled Duffle Bag",
    Price: "52$",
    Tags: "bag, duffle, Rec, Recycled content, luggage, popular ",
    img1: "https://mec.imgix.net/medias/sys_master/high-res/high-res/9072944840734/6002215-BK000-ALT-BACK.jpg?w=600&h=600&auto=format&q=40&fit=fill&bg=FFF",
...

  {
    ...
    Description:
      "Signoraware's range of Lunch Boxes is high on style and does not compromise on any health and safety standards. These lunch boxes are tough, sturdy and made of 100% food grade materials which do not leach and bleed into your food even when packed with fresh hot meals; preserving their original taste and aroma all day long Dishwasher safe steel containers Airtight leak-proof / crack proof stainless steel containers Unique insulated bag keeps food warm for longer hour Spill-proof lids made of recyclable virgin plastic",
    Name: "Stainless-steel Tiffin Box | 2 pieces",
    Price: "261$",

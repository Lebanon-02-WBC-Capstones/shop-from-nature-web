  ...
  return (
    <div className="flex bg-mainbg">
      ...
      <div className="w-full w-x-auto mx-auto  mt-10 ml-10 flex flex-col">
        <h1 className="text-2xl border-b-2 border-opacity-25 text-red text-sans"> Chapter Mips Helmet </h1>
        ...
        <div className="bg-white divide-x-2 divide-red divide-opacity-60 flex justify-between items-center max-w-2xs ">
          <button onClick={plus} className="text-2xl transform hover:scale-125 motion-reduce:transform-none text-grey pl-2">
            +
          </button>
        ...
        <div className="self-start mt-4">
          ...
          <p className="mb-4 mt-4 text-red text-sm">Tags:<span className="text-grey pl-1">glass</span> </p> <button class="transform hover:scale-110 motion-reduce:transform-none bg-green text-white  font-bold uppercase text-sm px-6 py-3 rounded-lg shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150" type="button"
      >
  Add to cart
</button>
        </div>

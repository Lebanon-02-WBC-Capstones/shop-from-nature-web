...
export default function ContactUsModel({open,setOpen}) {
    ...
    <Transition.Root show={ open} as={Fragment}>
      ...
      >
        ...
        <Transition.Child
          ...
          <span className="bg-mainbg hidden sm:inline-block sm:align-middle " aria-hidden="true">
            &#8203;
          </span>
          <Transition.Child
            as={Fragment}
          ...
          > 
            <div className="inline-block align-bottom bg-mainbg rounded-lg text-left overflow-hidden  transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
              ...
              <div className="mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full text-black sm:mx-0 sm:h-10 sm:w-10">
    
                  </div>
                  <div className=" mt-3  sm:mt-0 sm:ml-4 sm:text-left">
                  
                  
              <Dialog.Title as="h3" className="w-full inline-flex justify-center text-2xl  leading-6 font-medium text-sans text-red">
